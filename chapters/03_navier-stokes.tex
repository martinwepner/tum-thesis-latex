...
\par Equation \ref{navier-stokes1} - the "momentum equation" - very briefly describes how the fluid accelerates due to the forces acting on it. Eq. \ref{navier-stokes2} is called "incompressibility condition" and means that the density of the fluid doesn't change over time.
